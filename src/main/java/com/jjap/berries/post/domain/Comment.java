...
public class Comment extends BaseEntity {
    ...
    private Comment(Post post, User author, String content, Comment rootComment, Comment replyToComment) {
        this.post = post;
        this.author = author;
    ...
    public static Comment reply(Post post, User author, String content, Comment rootComment, Comment replyToComment) {
